...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "zein"
...
async def cmd_list(event):
    ...
    if not event.text[0].isalpha() and event.text[0] not in ("/" , "#", "-", "_", "@"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            if len(string) > 69:
                ...
                with io.BytesIO(str.encode(string)) as out_file:
                    ...
                    await bot.send_file(
                        ...
                        caption="COMMANDS In P〇Ḱᕮᙢ〇η 𝚄𝚂𝙴𝚁𝙱𝙾𝚃",
            ...
            help_string = f"""Userbot Helper.. 𝗣𝗥𝗢𝗩𝗜𝗗𝗘𝗗 𝗕𝗬 P〇Ḱᕮᙢ〇η 𝗨𝗦𝗘𝗥𝗕𝗢𝗧 \n
...
async def _(event):
    ...
    await event.edit("Telethon UserBot powered pokemon 𝚋𝚘𝚝")
