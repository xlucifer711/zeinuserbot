...
BOT = str(botnickname) if botnickname else "zein BOT"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "black BOY"
PHOTO = os.environ.get("ALIVE_PHOTTO", None)
DEVIL = "[zein](https://t.me/wjj_u)"
VERSION = "3.1.5"
REPO = "[DEVIL BOT](https://github.com/LUCIFEERMORNINGSTAR/DEVIL)"
PRO = bot.uid
MASTER = f"[{NAME}](tg://user?id={PRO})"
GROUP = "[SUPPORT GROUP](https://t.me/AQOOX2)"
